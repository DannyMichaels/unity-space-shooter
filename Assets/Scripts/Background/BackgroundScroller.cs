...
public class BackgroundScroller : MonoBehaviour
{
  ...
  private void ScrollBackground()
  {
    ...
    BG1.position -= new Vector3(scrollSpeed * Time.deltaTime, BG1.position.y, 0f); // this is the same code as above but written differently
    BG2.position -= new Vector3(scrollSpeed * Time.deltaTime, BG2.position.y, 0f);
  ...
  private void HandleMoveToEnd(Transform bg)
  {
    ...
    {
      bg.position += new Vector3(bgWidth * 2f, bg.position.y, 0f);
    }
  }
}
